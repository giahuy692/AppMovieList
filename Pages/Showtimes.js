...
let Showtimesdb = [
  {
    ...
    lich: [
      {
        category: "2D PHỤ ĐỀ / SUB",
        time: ["17:20", "20:20", "22:20", "23:30"],
      },
        ...
        <View key={index}>
          ...
          <View style={styles.timeList}>
            {item.time.map((time, idx) => {
              const isSelected =
                selectedTimeItem.time === time &&
                selectedTimeItem.cinema === nameTheater;
              return (
                <TouchableOpacity
                  key={idx}
                  style={[
...
const Showtimes = () => {
  ...
  const handleSelectButton = () => {
    if (Object.keys(selectedTimes).length > 0) {
      const selectedShowtimes = Showtimesdb.filter(
    ...
    <View style={styles.constainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.textHeader1}>
          (*)Select showtime to book tickets online
        </Text>
      </View>
      ...
      <View style={styles.menuFooter}>
        ...
        <TouchableOpacity style={styles.btnBuy} onPress={handleSelectButton}>
          <Text style={styles.textBtnBuy}>Select</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
